...
@section('body')
    <div class="flex min-h-screen items-center justify-center p-6">
        <div class="flex w-full gap-6">
            ...
            <div
                class="rounded-box bg-base-200 shadow-base fixed bottom-5 left-1/2 z-50 flex w-[5vw] justify-between px-4 py-4 shadow-lg max-sm:w-[90%] max-sm:-translate-x-1/2 sm:left-6 sm:top-6 sm:h-[calc(100vh-3rem)] sm:flex-col">
